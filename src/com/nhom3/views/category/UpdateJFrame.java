...
public class UpdateJFrame extends javax.swing.JFrame {
    ...
    public UpdateJFrame(int maTheLoai) {
        initComponents();
        this.setLocationRelativeTo(null);
        categoryModel = new TheLoai();
        categoryService = new TheLoaiService();   
        
        categoryModel.setMaTheLoai(maTheLoai);
        categoryModel.setTheLoai(categoryService.getCategoryById(maTheLoai));
        
        categoryTextField.setText(categoryModel.getTheLoai());
